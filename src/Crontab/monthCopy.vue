...
const cycleTotal = computed(() => {
  const _cycle01 = checkNum(cycle01.value, 1, 11);
  const _cycle02 = checkNum(cycle02.value, _cycle01 ? _cycle01 + 1 : 2, 12);
  return _cycle01 + "-" + _cycle02;
});
// 计算平均用到的值
const averageTotal = computed(() => {
  const _average01 = checkNum(average01.value, 1, 11);
  const _average02 = checkNum(average02.value, 1, 12 - _average01 || 0);
